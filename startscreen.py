...
class StartScreen(ScreenInterface):
    ...
    def screen_run(self):
        ...
        self.game.create_button('Capital', 'capital', WHITE, DARK_PURPLE, 150, 40, WIDTH / 6, HEIGHT / 2.2)
        self.game.create_button('Attractions', 'attractions', WHITE, DARK_PURPLE, 150, 40, WIDTH / 2.65, HEIGHT / 2.2)
        self.game.create_button('Food', 'food', WHITE, DARK_PURPLE, 150, 40, WIDTH / 1.65, HEIGHT / 2.2)
        self.game.create_button('Natural Wonders', 'nature', WHITE, DARK_PURPLE, 150, 40, WIDTH / 1.2, HEIGHT / 2.2)
    ...
    def button_function_run(self):
        ...
        if self.game.pressed == 'nature':
            self.game.current_screen = self.game.question_screen
            self.game.current_screen.current_category = 'nature'
